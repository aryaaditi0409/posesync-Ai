...
const ANGLE_FEEDBACK = {
    ...
    leftArm: "Adjust your left arm.",

    rightArm: "Adjust your right arm.",

    leftLeg: "Adjust your left leg.",

    rightLeg: "Adjust your right leg.",

    leftTorso: "Straighten your upper body.",

    rightTorso: "Straighten your upper body."

};

function generateFeedback(angleMistakes, landmarkMistakes){

    const feedback = [];

    // Angle based feedback
    angleMistakes.slice(0,2).forEach(mistake=>{

        if(
            mistake.difference > 15 &&
            ANGLE_FEEDBACK[mistake.joint]
        ){
    ...
    // Landmark feedback
    landmarkMistakes.slice(0,2).forEach(mistake=>{

        feedback.push(

            `Move your ${mistake.joint} closer to the reference pose.`
...
export function comparePose(referenceLandmarks, liveLandmarks){
    ...
    if(
        !validPose(referenceLandmarks) ||
        !validPose(liveLandmarks)
    ){
    ...
    // Compare angles
    const angleResult = compareAngles(
    ...
    // Compare landmarks
    const landmarkResult = compareLandmarks(
    ...
    const score = calculateScore(
        ...
        angleResult.averageDifference,

        landmarkResult.averageDistance
    ...
    const feedback = generateFeedback(
        ...
        angleResult.mistakes,

        landmarkResult.mistakes
    ...
    return{
        ...
        worstJoints:[
            ...angleResult.mistakes.slice(0,2),
            ...landmarkResult.mistakes.slice(0,2)
        ]
